...
CREATE INDEX IF NOT EXISTS room_restrictions_room_id_idx ON room_restrictions(room_id);
CREATE INDEX IF NOT EXISTS room_restrictions_reservation_id_idx ON room_restrictions(reservation_id);
